...
extern const char _binary_atomicservicemenubar_abc_start[];
extern const char _binary_atomicservicemenubar_abc_end[];
...
namespace OHOS::AtomicServiceMenubar {
    ...
    static napi_value Init(napi_env env, napi_value exports)
    {
        ...
        napi_property_descriptor desc[] = {
            DECLARE_NAPI_FUNCTION("setMenubarVisible", MenubarAPIImplement::setMenubarVisible),
        };
    ...
    void NAPI_atomicservice_AtomicServiceMenubar_GetABCCode(const char **buf, int *buflen)
    {
        ...
        if (buflen != nullptr) {
            *buflen = _binary_atomicservicemenubar_abc_end - _binary_atomicservicemenubar_abc_start;
        }
    }
